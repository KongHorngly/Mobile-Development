...
class CheckBox extends StatelessWidget {
  ...
  BoxBorder? get border => checked ? null : Border.all(color: AppTheme.greenColor, width: 2);
  Color? get backbroundColor => checked? AppTheme.greenColor : Colors.transparent;
  Widget? get innerIcon => checked? const Icon(Icons.check,color: Colors.white):null;
